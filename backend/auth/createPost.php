...
try {
    ...
    // FIXED: Added post_image placeholder (now 7 columns = 7 placeholders)
    $stmt = $db->prepare("
        INSERT INTO post (user_id, post_category, post_title, post_content, post_image, post_visibility, post_date) 
        VALUES (?, ?, ?, ?, ?, ?, NOW())
    ");
